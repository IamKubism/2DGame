...
public class Prototype : ICloneable
{
    ...
    [JsonProperty]
    Dictionary<string, string> fixed_components;

    [JsonProperty]
    List<string> variable_components;
    ...
    public void SetFixedComps(Dictionary<string,string> comp_dict, Dictionary<string,string> system_dict, Dictionary<string,int> comp_priorities)
    {
    ...
    public void SetVariableComps(List<string> comps, Dictionary<string, string> system_dict, Dictionary<string, int> comp_priorities)
    {
    ...
    public object Clone()
    {
        ...
        {
            fixed_components = new Dictionary<string, string>(fixed_components),
            ...
            variable_components = new List<string>(variable_components)
        };
    }
    ...
    public static void LoadFromAppender(Prototype self, Prototype appender)
    {
        self.SetVariableComps(appender.variable_components, appender.system_names, appender.component_load_priorities);
        self.SetFixedComps(appender.fixed_components, appender.system_names, appender.component_load_priorities);
    }
}
