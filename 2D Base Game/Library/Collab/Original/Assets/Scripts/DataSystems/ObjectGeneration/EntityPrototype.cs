...
public class Prototype : ICloneable
{
    ...
    [JsonProperty]
    public Dictionary<string, string> fixed_comps;

    [JsonProperty]
    public Dictionary<string, string> variable_components;
    ...
    public Prototype(string prototype_name)
    {
        ...
        fixed_comps = new Dictionary<string, string>();
    ...
    {
        if(fixed_comps.ContainsKey(comp_type) == false)
        {
            fixed_comps.Add(comp_type, comp_id);
        } else
        {
            fixed_comps[comp_type] = comp_id;
        }
    }
    ...
    {
        return fixed_comps.ContainsKey(comp_type) ? fixed_comps[comp_type] : "NULL";
    }
    ...
    public object Clone()
    {
        ...
        {
            fixed_comps = new Dictionary<string, string>(fixed_comps),
